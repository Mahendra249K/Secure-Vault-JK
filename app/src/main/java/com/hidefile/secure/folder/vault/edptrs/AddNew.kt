...
class AddNew(
        ...
        return traverse({ dir, nextDocId, childrenUri ->
            if (nextDocId == "") {
                if (makeDirectories) {
                    ...
                    throw BDGenerator("No such file or directory")
                }
    ...
    private fun createBlankDoc(
        ...
        return DocumentsContract.createDocument(
            ...
            if (isCopyOepration) {
                ...
                Log.i("TAG", "createBlankDoc: copyFilePath :- $copyFilePath")
    ...
    override fun toString(): String {
        return "CreateFile(context=$context, contentResolver=$contentResolver, path='$path', rootUri=$rootUri, rootDocumentId='$rootDocumentId', isCopyOepration=$isCopyOepration, copyFilePath=$copyFilePath, isImage=$isImage, mimeType='$mimeType', blankUri=$blankUri)"
    }
